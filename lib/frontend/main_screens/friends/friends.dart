...
import 'package:CareTalk/frontend/main_screens/friends/requests.dart';
import 'package:CareTalk/frontend/preview/image_preview.dart';
import 'package:CareTalk/models/request_model.dart';
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          _requestButton(
                              ...
                              color: Colors.teal// const Color.fromARGB(255, 216, 116, 8)
                          ),
                          const SizedBox(width: 15.0),
                          const Text('Contacts: ',
                              style: TextStyle(
        ...
        leading: GestureDetector(
            child: CircleAvatar(
                ...
                backgroundImage: FileImage(File(_allconnectionsPrimaryInfo[index]
                    ...
                    .split('/////')[1]))),
            onTap: () {
              //print('con primary key: ${_allconnectionsPrimaryInfo[index].keys.first}');
              Navigator.push(
                  context,
                  PageTransition(
                      type: PageTransitionType.fade,
