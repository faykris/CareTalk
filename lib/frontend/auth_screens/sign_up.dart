...
import 'package:CareTalk/backend/firebase/auth/email_and_password_auth.dart';
import 'package:CareTalk/backend/firebase/auth/google_auth.dart';
...
import 'package:CareTalk/frontend/new_user_entry_screen/new_user_entry.dart';
...
import 'package:CareTalk/global_uses/reg_exp.dart';
...
// common textFormField
    ...
    return Padding(
      ...
      child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(icon, color: kSecondaryAppColor, size: 18.0),
  ...
  Widget _signupText() {
    return Padding(
      padding: const EdgeInsets.only(top: 2.0, bottom: 18.0),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const SizedBox(height: 50),
        Center(
          child: Image.asset(
            "assets/images/caretalk-logo1.png",
            height: 100.0,
            width: 350.0,
          ),
        ),
        ...
        // const Center(
        //   child: Text('Please fill in the inputs below',
        //       style: TextStyle(
        //           color: kGrey,
        //           fontSize: 14.0,
        //           letterSpacing: 1.0,
...
//button to signup with email and password
  Widget _signupButton(BuildContext prevContext) {
    return Padding(
        ...
        onPressed: () async {
          if (_signupKey.currentState!.validate()) {
            ...
            if (response == EmailSignUpResults.signUpCompleted) {
              ...
              alert(
                  title: "Email verification link has been sent. Don't forget check the Spam if necessary",
                  context: context
              );
              Timer(const Duration(seconds: 5), () {
                Navigator.pop(context);
                Navigator.pushReplacement(prevContext,
